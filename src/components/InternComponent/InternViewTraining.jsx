...
import { Card, Row, Col, Typography, message, Layout, Input, Collapse, Table, Button, Popconfirm, Spin } from "antd";
...
export default InternViewTraining;
