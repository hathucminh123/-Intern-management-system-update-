...
import { Card, Row, Col, Typography, message, Layout, Input, Pagination, Space, Image, Button, Popconfirm, Spin } from "antd";
...
const JobsIC = () => {
  ...
  const handleDetails = (item) => {
    navigate(`/${userRole}/Detailll/${item.id}`, { state: { item } });
  };
