...
const jobsDetailData = [
    {
        id: 1,
        title: "Thực Tập React",
        extra: "Chỉnh sửa",
        image: reactImage,
        duration: "Kéo dài 3-6 tháng",
        deadline: "10/10/2024",
        workTime: "full time",
        jobDescription: [
    ...
    },
    {
        ...
        extra: "Chỉnh sửa",
        image: nodeJs,
        duration: "Kéo dài 4-6 tháng",
        deadline: "15/11/2024",
        workTime: "part time",
        jobDescription: [
            "Mô tả công việc cho thực tập Node.js tương tự như mô tả cho thực tập React",
        ],
        jobRequirements: [
            "Yêu cầu công việc cho thực tập Node.js tương tự như yêu cầu cho thực tập React",
        ],
        benefits: [
            "Phúc lợi cho thực tập Node.js tương tự như phúc lợi cho thực tập React",
        ],
    },
    {
        id: 3,
        ...
        extra: "Chỉnh sửa",
        image: javaImage,
        duration: "Kéo dài 3-5 tháng",
        deadline: "20/12/2024",
        workTime: "full time",
        jobDescription: [
            "Mô tả công việc cho thực tập Java tương tự như mô tả cho thực tập React",
        ],
        jobRequirements: [
            "Yêu cầu công việc cho thực tập Java tương tự như yêu cầu cho thực tập React",
        ],
        benefits: [
            "Phúc lợi cho thực tập Java tương tự như phúc lợi cho thực tập React",
        ],
    },
];

export default jobsDetailData;
